...
public class BaZiFuChuanZhuanHuanChengZhengShuLcof{
    public static void main(String[] args) {
        ...
        System.out.println(solution.strToInt("-000000000000001"));
    }
...
class Solution {
    public int strToInt(String str) {
            ...
            if(first=='+'||first=='-'||(first>='0'&&first<='9')){
                int cur=1;
                while(cur<=str.length()-1&&str.charAt(cur)>='0'&&str.charAt(cur)<='9'){
                    cur++;
                }
                if(cur==1){
                   if(first=='+'||first=='-'){
                       ...
                       res=Double.parseDouble(String.valueOf(first));
                   }

                }
                res=Double.parseDouble(str.substring(0,cur));
