...
class Solution {
    public int maxIncreaseKeepingSkyline(int[][] grid) {
        ...
        for(int i=0;i<n;i++){
            for(int j=0;j<m;j++){
               sum+=Math.min(stander[i],stander[n+j])-grid[i][j];
